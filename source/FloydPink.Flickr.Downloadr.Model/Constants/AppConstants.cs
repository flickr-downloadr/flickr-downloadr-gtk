namespace FloydPink.Flickr.Downloadr.Model.Constants {
    public static class AppConstants {
        ...
        public const string AuthenticatedMessage =
            ...
            "<img alt=\"flickr downloadr\" src=\"http://flickrdownloadr.com/static/images/logo.png\" />" +
        ...
        public const string MoreThan1000PhotosWarningFormat =
            "There are a total of {0} photos to be downloaded! \n\nThis WILL take quite a while. Are you sure?";

        public const string MoreThan500PhotosWarningFormat =
            "You are going to download {0} photos. \n\nIt could take a while. Continue?";
